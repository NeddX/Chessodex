...
*** Windows
To install on Windows just select the =shipping= preset and hit the =Install Chessodex= under =Build=.
This will install the game under =C:/Program Files (x86)/Chessodex=.

For uninstallation on Windows just delete the folder =C:/Program Files (x86)/Chessodex= and you migth also want to delete the folders assosicated with Chessodex =%LOCALAPPDATA%=.
